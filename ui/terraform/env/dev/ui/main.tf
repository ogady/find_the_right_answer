...
module "ecs" {
  ...
  env                   = var.env
  alb_terget_group_arn  = data.terraform_remote_state.network.outputs.http_alb_terget_group_arn
  ...
  security_group_id     = data.terraform_remote_state.network.outputs.http_security_group_id
